...
$data_pend = mysqli_query($koneksi, "SELECT * FROM form_pendaftaran");

$jumlah_data = mysqli_num_rows($data_pend);
$total = ceil($jumlah_data / $batas);
$nomor = $halaman_awal + 1;

$data = mysqli_query($koneksi, "SELECT * FROM form_pendaftaran LIMIT $halaman_awal, $batas");
        ...
        <div class="app-content pt-3 p-md-3 p-lg-4">
            <div class="container-xl">
                ...
                <div class="row jus mb-4">
                    ...
                    <div class="col-auto">
                        <a href="download_excel.php" class="btn app-btn-secondary"><i class="fa-solid fa-cloud-arrow-down"></i> Download CSV</a>
                    </div>
                    <!--//app-search-box-->
                </div>
